...
- [C++ Tips and Tricks](#c-tips-and-tricks)
  ...
  - [2. Tips and Tricks ](#2-tips-and-tricks-)
    - [2.1 C++ is NOT C ](#21-c-is-not-c-)
    - [2.2 C++ is just moving memory around ](#22-c-is-just-moving-memory-around-)
    - [2.3 Plan your code before you write it ](#23-plan-your-code-before-you-write-it-)
    - [2.4 The Rubber Ducky Method ](#24-the-rubber-ducky-method-)
    - [2.5 Organise your code ](#25-organise-your-code-)
    - [2.6 Pointer Arithmetic ](#26-pointer-arithmetic-)
    - [2.7 Use const and scoping ](#27-use-const-and-scoping-)
    - [2.8 Header Guards ](#28-header-guards-)
    - [2.9 Try using a UNIX platform ](#29-try-using-a-unix-platform-)
    - [2.10 Effective C++ ](#210-effective-c-)
